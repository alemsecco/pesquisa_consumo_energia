...
if __name__ == '__main__':
	...
	p = argparse.ArgumentParser(description='Filtrar consumo residencial')
	p.add_argument('-i', '--input', help='Caminho para Dados_abertos_Consumo_Mensal.csv')
	p.add_argument('-o', '--output', help='Caminho para saída Dados_residencial.csv')
	args = p.parse_args()

	if args.input:
		in_file = args.input
	else:
		# default: arquivo ao lado deste script
